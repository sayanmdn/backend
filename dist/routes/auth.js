...
router.post("/signup", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (req.body.role === "TEACHER") {
        ...
        const user = new User_1.default({
            ...
            subjects: req.body.subjects.map((element) => (0, lodash_1.toUpper)(element.subject.trim())) || undefined,
...
router.post("/login", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const token = jsonwebtoken_1.default.sign({ id: userByEmail._id, name: userByEmail.name, role: userByEmail.role || "USER" }, process.env.SECRET_JWT_TOKEN);
...
router.post("/otpsend", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        if (req.body.role === constant_1.TEACHER_USER_ROLE || req.body.role === constant_1.STUDENT_USER_ROLE) {
...
router.get("/news", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const returnedData = yield News_1.default.find({ time: { $gt: new Date(Date.now() - 60 * 60 * 1000) } });
